Torrents = function(transmission) {
  ...
  transmission.get('#/torrents', function() {
  ...
  transmission.get('#/torrents/new', function() {
  ...
  transmission.get('#/torrents/add', function() {
  ...
  transmission.del('#/torrents', function() {
  ...
  transmission.post('#/torrents', function() {
  ...
  transmission.put('#/torrents/:id', function() {
  ...
  transmission.put('#/torrents', function() {
    var ids = $.map(context.params['ids'].split(','), function(id) {return parseInt(id, 10);});
  ...
  transmission.bind('torrents-refreshed', function(e, params) { with(this) {
  ...
  transmission.bind('torrent-refreshed', function(e, torrent) { with(this) {

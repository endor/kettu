describe("SortTorrentsHelpers", function() {
  ...
  it("should be sortable by name", function() {
    ...
    expect(sorted_torrents[0].id).toEqual('2')
    expect(sorted_torrents[1].id).toEqual('3')
    expect(sorted_torrents[2].id).toEqual('1')
  });
  ...
  it("should be sortable by activity", function() {
    ...
    expect(sorted_torrents[0].id).toEqual('1')
    expect(sorted_torrents[1].id).toEqual('3')
    expect(sorted_torrents[2].id).toEqual('2')
  });
  ...
  it("should be sortable by progress", function() {
    ...
    expect(sorted_torrents[0].id).toEqual('4')
    expect(sorted_torrents[1].id).toEqual('3')
    expect(sorted_torrents[2].id).toEqual('2')
    expect(sorted_torrents[3].id).toEqual('1')
  });
  ...
  it("should be sortable by queue", function() {
    ...
    expect(sorted_torrents[0].id).toEqual('1')
    expect(sorted_torrents[1].id).toEqual('2')
    expect(sorted_torrents[2].id).toEqual('3')
  });

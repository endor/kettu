Feature: Torrent info
  ...
  # NOTE: double clicking is currently not testable with capybara
  ...
  #   Then the "location" field should contain "/downloads"
  #   When I double click on the torrent
  #   Then the torrent info should be closed
  ...
  Scenario: double clicking on a torrent and then single clicking on another one updates info
    ...
    When I go to the start page
      ...
      And I wait for the AJAX call to finish
    Then the "location" field should contain "/my_torrents"
  ...
  Scenario: info displays file information
    ...
    Then I should see "12 bytes"
      And I should see "50%"
      And the "file_0" checkbox should not be checked
